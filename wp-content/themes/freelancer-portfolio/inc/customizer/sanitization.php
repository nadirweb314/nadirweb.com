 ...
 */
function freelancerportfolio_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function freelancerportfolio_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function freelancerportfolio_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function freelancerportfolio_sanitize_float( $input ) {
 ...
 */
function freelancerportfolio_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function freelancerportfolio_sanitize_html( $html ) {
 ...
 */
function freelancerportfolio_sanitize_image( $image, $setting ) {
 ...
 */
function freelancerportfolio_sanitize_nohtml( $nohtml ) {
 ...
 */
function freelancerportfolio_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function freelancerportfolio_sanitize_range_value( $number, $setting ) {
 ...
 */
function freelancerportfolio_sanitize_select( $input, $setting ) {
 ...
 */
function freelancerportfolio_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function freelancerportfolio_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function freelancerportfolio_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
